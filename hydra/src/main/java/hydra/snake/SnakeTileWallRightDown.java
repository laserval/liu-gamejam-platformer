...
public class SnakeTileWallRightDown extends SnakeTile {
	Image[] wallImages = new Image[1];
	Animation wallAnim = new Animation(false);

	public SnakeTileWallRightDown(int x, int y, Rectangle rect) {
		super(x, y, rect);

		try {
			wallImages[0] = new Image("border_tile_down_right.jpg");
